...
function generate_bill(){
  ...
  while($row = mysqli_fetch_array($query)){
    ...
    <label> Fees Paid : </label> Rs '.$row["docFees"].'<br/>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i>VIP Hospital </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">XYZ</a>
      ...
      <tr>
        ...
        <td>
          ...
          <?php } else if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 0)) { ?>
            ...
            <a href="admin-panel.php?ID=<?php echo $row['ID'] ?>&completed=update" onClick="return confirm('Are you sure this appointment is completed?')" title="Mark Appointment as Completed" tooltip-placement="top" tooltip="Completed">
